            ...
            <div className="container text-center text-md-left">
                <div className="row">
                    ...
                    <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                        ...
                        <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="social-link d-block mb-3">
                            <i className="fab fa-facebook fa-2x"></i> Facebook
                        </a>
                        <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className="social-link d-block mb-3">
                            <i className="fab fa-twitter fa-2x"></i> X
                        </a>
                        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="social-link d-block mb-3">
                            <i className="fab fa-instagram fa-2x"></i> Instagram
                        </a>
                        <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="social-link d-block mb-3">
